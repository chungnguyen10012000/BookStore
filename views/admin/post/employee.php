<?php
    ...
    function editEmployee($mysql_db,$id,$fname,$work,$avatar,$face,$twitter,$insta){
        $sql = "UPDATE employee SET name='$fname', role='$work', image='$avatar', facebook = '$face',
                twitter='$twitter', instagram='$insta' WHERE id = $id ";
    ...
    function addEmployee($mysql_db,$fname,$work,$avatar,$face,$twitter,$insta){
        $sql = "INSERT INTO employee(name,role,image,facebook,twitter,instagram) 
