...
<nav class="navbar navbar-expand-md navbar-dark bg-dark border-bottom sticky-top">
    <a class="navbar-brand" href="../home/index.php">
        <img src="../../../assets/images/home/logo.png" alt="BookStore" class="" with='35px' height='35px'>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <div class="navbar-nav ml-auto">
            <li class="nav-item active">
                <form class="form-inline" action="../product/index.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../about/index.php">About <span class="sr-only"></span></a>
            </li>
            <li class="nav-item active">
                      ...
                      if (!empty($_SESSION['email'])) {
                          ...
                          <div class='nav-item dropdown'>
                              ...
                              <div class='dropdown-menu dropdown-menu-right' aria-labelledby='navbarDropdownMenuLink'>
                                  <a class='dropdown-item' href='../account/index.php'>
