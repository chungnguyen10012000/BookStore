        ...
        if (isset($_SESSION['email'])) {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (empty($_POST['email']) || empty($_POST['password'])) {
                    ...
                    $query = "select id ,name, email, phone, birthday, password, active from customer where email=?";
                    ...
                    if(mysqli_stmt_num_rows($stmt) == 1){                                          
                        ...
                        mysqli_stmt_bind_result($stmt, $id ,$name, $email, $phone, $birthday, $hashed_password, $active);
